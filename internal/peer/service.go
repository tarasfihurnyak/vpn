...
func (s *Service) Create(ctx context.Context, userID uuid.UUID, name, publicKey string, ipAddress netip.Addr) (Peer, error) {
...
func (s *Service) GetByID(ctx context.Context, id uuid.UUID) (Peer, error) {
...
func (s *Service) GetByUser(ctx context.Context, userID uuid.UUID) (Peer, error) {
...
func (s *Service) ListByUser(ctx context.Context, userID uuid.UUID) ([]Peer, error) {
